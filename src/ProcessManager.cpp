...
Process* ProcessManager::createProcess(int space, string pid, int runtime, int arrivaltime, int priority, int attribute) {
    Process* proc = new Process(space, pid, runtime, arrivaltime, priority, "new", attribute);
    allProcs[pid] = proc;
