...
ResourceManager::ResourceManager(PagingMemoryManager* pm, int totalframes,int framesize) : pagingManager(pm) {
    pagingManager = new PagingMemoryManager(totalframes, framesize);
    initializeResources();
}
...
void ResourceManager::initializeResources() {
    ...
    // 为每种资源创建对应的信号量
    SystemSemaphores["CPU"]     = new Semaphore(resources["CPU"]->available,     "CPU");
    SystemSemaphores["Disk"]    = new Semaphore(resources["Disk"]->available,    "Disk");
    SystemSemaphores["Printer"] = new Semaphore(resources["Printer"]->available, "Printer");
}
