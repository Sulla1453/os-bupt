...
public:
    ...
    Process();
    Process(int _space, string _pid, int _runtime, int _arrivaltime, int _priority, string _state, int _attribute, vector<string> pre);
